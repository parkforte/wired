	                        ...
	                        <div class="card-body">
	                            <div class="table-responsive">
	                                ...
	                                <br>
										...
										<button type="button" class="btn btn-danger b-radius" onclick="location.href='<c:url value='/addbook/addressBookList'/>'">취소</button>
                                	</div>
	                            </div>
			  ...
			  <div class="modal-dialog modal-dialog-centered">
			    <div class="modal-content">
			      ...
			      <div class="modal-footer">
			        ...
			        <button type="submit" id="addEdit_submit" class="btn btn-primary b-radius">확인</button>
			      </div>
			    </div>
			  </div>
			</div>
