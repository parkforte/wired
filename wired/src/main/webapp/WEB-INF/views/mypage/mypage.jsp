...
<nav>
	<div class="nav nav-tabs" id="nav-tab" role="tablist">
		<a class="nav-link active" id="nav-home-tab" data-toggle="tab"
			...
			aria-selected="true">사원정보수정</a> <a class="nav-link"
			id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
			aria-controls="nav-profile" aria-selected="false">게시판 알림</a> <a
			class="nav-link" id="nav-contact-tab" data-toggle="tab"
			href="#nav-contact" role="tab" aria-controls="nav-contact"
			aria-selected="false">나의 서명</a>
	</div>
</nav>
				...
				<div class="card-body">
					<form class="user">
						<div class="table-responsive">
							...
							<!-- 비밀번호 -->
							<div class="form-group">
								<label for="password1">비밀번호 </label> <input type="text"
									class="form-control form-control-user c-size" id="password1"
									style="width: 200px;">
							</div>
							<!-- 비밀번호확인 -->
							<div class="form-group">
								<label for="password2">비밀번호 확인</label> <input type="text"
									class="form-control form-control-user c-size" id="password2"
									style="width: 200px;">
							</div>
							<!-- 연락처 -->
							<div class="form-group">
								<label for="phoneNumber">연락처</label><br> <input type="text"
									class="form-control form-control-user c-size s-half-style"
									id="hp1" style="width: 100px; display: inline-block"> <span>-</span>
								<input type="text"
									class="form-control form-control-user c-size s-half-style"
									id="hp2" style="width: 100px; display: inline-block"> <span>-</span>
								<input type="text"
									class="form-control form-control-user c-size s-half-style"
							...
							<!-- 주소 -->
							<div class="form-group">
								<label for="zipcode">주소</label><br> <input type="text"
									name="zipcode" id="zipcode" title="우편번호"
									style="width: 200px; display: inline-block"
									class="form-control form-control-user c-size"
									placeholder="우편번호"> <input
									style="display: inline-block" type="Button" value="우편번호 찾기"
									id="btnZipcode" title="새창열림" class="btn btn-primary b-radius">
								<br />
								<span class="sp1">&nbsp;</span> <input type="text"
									name="address" title="주소"
									class="form-control form-control-user c-size" placeholder="주소">
								<span class="sp1">&nbsp;</span> <input type="text"
									name="addressDetail" title="상세주소"
									class="form-control form-control-user c-size"
									placeholder="상세주소">
							</div>
							<hr>
							...
							<!-- 연차 -->
							<div class="form-group">
								<label for="salary">연차</label> <input type="text"
									style="width: 200px;"
									class="form-control form-control-user c-size half-style"
									id="annual" ReadOnly>
							</div>
							<!--사용연차 -->
							<div class="form-group">
								<label for="salary">사용연차</label> <input type="text"
									style="width: 200px;"
									class="form-control form-control-user c-size half-style"
							...
							<!-- 부서 -->
							<div class="form-group">
								<label for="salary">부서</label> <input type="text"
									style="width: 200px;"
									class="form-control form-control-user c-size half-style"
									id="jumin1" ReadOnly>
							</div>
							<!-- 직급 -->
							<div class="form-group">
								<label for="salary">직급</label> <input type="text"
									style="width: 200px;"
									class="form-control form-control-user c-size half-style"
									id="jumin2" ReadOnly>
							</div>
