	...
	<div class="container-fluid">
							...
							<c:forEach var="vo" items="${list }">
								<table class="table table-bordered " id="dataTable" style="width: 100%;">
									...
									<tr>
										...
										<td>
											<!-- 종류삭제 --> <a
											href="<c:url value='/e-approval/doctype/deleteDoc?typeNo=${vo.typeNo}'/>">
		...
		<div class="card shadow mb-4">
			...
			<div
				...
				<h6 class="m-0 font-weight-bold text-primary">상세정보등록 (라인종류명:)</h6>
			</div>
			...
			<div class="card-body">
				...
				<form method="post"
					action="<c:url value='/e-approval/confirm/confirmLine'/>">
