...
ALTER TABLE RESOURCES ADD(RES_LAT VARCHAR2(150 BYTE));
ALTER TABLE RESOURCES ADD(RES_LNG VARCHAR2(150 BYTE));
...
(
    ...
    S.RESERV_CONTENT, D.DEPT_NAME, S.RESERV_NO, R.RES_LAT, R.RES_LNG, R.RES_LOCATION
    FROM RESTYPE T JOIN RESOURCES R
    ON T.TYPE_NO=R.TYPE_NO
    JOIN RESSCHEDULE S
