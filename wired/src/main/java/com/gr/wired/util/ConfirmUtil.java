...
public class ConfirmUtil {
	...
	public static final int STATE_REPORT_UP1=1;	//대기
	public static final int STATE_REPORT_UP2=2;	//결재중
	public static final int STATE_APPROVAL=3; //승인
	public static final int STATE_REJECT=4;	//반려
